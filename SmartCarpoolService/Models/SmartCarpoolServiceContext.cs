...
namespace SmartCarpoolServiceService.Models
{
    public class SmartCarpoolServiceContext : DbContext
    {
        ...
        public SmartCarpoolServiceContext() : base(connectionStringName)
        {
        } 
